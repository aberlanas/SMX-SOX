#+Title: Unidad 01 - Tarea 03 : Compartir Recursos
...
#+LATEX_HEADER: \fancyhead[L]{UD01 : Tarea 03 Compartir Recursos}
...
/Una vez tengamos la máquina de Xubuntu con los pasos descritos, realizad/
/los pasos necesarios para que también tengamos esas posibilidades en Windows./
...
* Tarea de Continuación 
  ...
  Realiza la misma instalación de las /Guest Additions/ en la máquina Windows
  10. 
